...
@yield('title_postfix', config('adminlte.title_postfix', ''))</title>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ asset('public/vendor/bootstrap/dist/css/bootstrap.min.css') }}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('public/vendor/font-awesome/css/all.min.css') }}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('public/vendor/Ionicons/css/ionicons.min.css') }}">
...
<script src="{{ asset('public/vendor/jquery/dist/jquery.slimscroll.min.js') }}"></script>
